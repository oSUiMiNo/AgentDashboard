 ...
 * **41→40**（2026-08-31・要件15-9）。寿命を 1.2倍にしたぶん、速さを 0.8倍に保つには
 * 道のりを 0.96倍にする——1区間ぶん減らすのがいちばん近い（設計§23-5）。
 * 1区間 56px は据え置き（「1区間 93px は粗い」の経緯と、行ピッチ 111px の半分という根拠）。
 */
export const ROAM_STOPS = 40
 ...
 * 等速なので時刻は道のりで決まり、1区間 56px ÷ 20.73px/秒 ＝ **2.70秒**。
 ...
 * **29→28**（2026-08-31・要件15-9。寿命 84秒で「さらに 0.8倍」の 100.9%。設計§23-5） */
export const ROAM_ROAM = 28
 ...
 *
 * 29区間 × 56px ＋ 巻き 117.4px ＝ 1741.4px を 84秒で走るので **20.73px/秒**
 *（要件15-9 の「0.8倍」の 100.9%。区間は整数なので割り切れない。設計§23-5）。
 */
