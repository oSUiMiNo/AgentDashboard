 ...
 * 並べ替えられない**。
 *
 * **承知のうえで、いまは決めていない**（並べ替え設計§13）。前例が無く、直前に入れた
 * `フォルダのパネルの幅をドラッグで変えられるようにする` もポインタ専用である。
 * **「できなくてよい」と決めたのではない**——必要になったときに別のイシューとして
 * 起こす。起こすなら、上下へ動かすボタンか、キーボードで掴んで矢印で動かす形になる。
 *
